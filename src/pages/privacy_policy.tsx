  ...
  <>
    ...
    >
      <Box gap={2}>
        ...
        <Typography variant="body1" color="grey.800" mt="8px">
        ...
        <Box component="ul" pl="20px">
          ...
          <li>
            <Typography variant="body1" color="grey.800" mt="8px">
              ...
              &quot;Our&quot; in this Agreement) refers to JNV Paota Jaipur Alumni Association, Jaipur.
            </Typography>
          </li>
          <li>
            <Typography variant="body1" color="grey.800" mt="8px">
          ...
          <li>
            <Typography variant="body1" color="grey.800" mt="8px">
              <strong>Website</strong> refers to The Official Alumni Network of Jawahar Navodaya Vidyalaya, Paota,
              Jaipur, accessible from{' '}
              <a href="https%3B//jnvpjaa.org" rel="external nofollow noopener" target="_blank">
                https;//jnvpjaa.org
              </a>
            </Typography>
          </li>
        ...
        <Box component="ul" pl="20px">
          <li>
            <Typography variant="body1" color="grey.800" mt="8px">
              By email: alumni@jnvpjaa.org
            </Typography>
          </li>
          <li>
            <Typography variant="body1" color="grey.800" mt="8px">
              By visiting this page on our website: <Link href="/contact-us">https://www.jnvpjaa.org/contact-us/</Link>
            </Typography>
          </li>
        </Box>
        <Typography color="greu.800" mt="20px">
