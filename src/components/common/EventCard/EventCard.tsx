...
const EventCard: React.FC<EventCardProps> = ({ event }) => {
  const { id, title, description, startDate, endDate, image, hostingMedium, online, people } = event;
    ...
    <Card sx={{ boxShadow: 3, borderRadius: 2 }}>
      ...
      <CardContent>
        ...
        <Box mt={2} display="flex" justifyContent="space-between" alignItems="center">
          ...
          <Chip label={hostingMedium} color={online ? 'success' : 'info'} sx={{ fontWeight: 500 }} />
        </Box>
