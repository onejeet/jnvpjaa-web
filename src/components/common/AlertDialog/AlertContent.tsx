...
const AlertContent: React.FC<AlertContentProps> = ({ title, message, action = 'delete', items = [] }) => {
  ...
  const iconComp = React.useMemo(() => {
    if (action === 'delete' || action === 'approve' || action === 'reject' || action === 'request') {
      ...
      // return <Image width={60} height={60} src="https://assets.jnvpjaa.org/svg/loading_animation.svg" alt="loading" />;
      ...
      // return <Image width={60} height={60} src="https://assets.jnvpjaa.org/svg/success_animation.svg" alt="success" />;
      ...
      // return <Image width={60} height={60} src="https://assets.jnvpjaa.org/svg/error_animation.svg" alt="success" />;
      ...
      // return <Image width={60} height={60} src="https://assets.jnvpjaa.org/svg/delete_animation.svg" alt="deleting" />;
