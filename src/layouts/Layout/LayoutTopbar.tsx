...
const LayoutTopbar: React.FC<LayoutTopbarProps> = ({ position = 'top' }) => {
  ...
  const canAccessAdminCenter = React.useMemo(
    () =>
      ...
      can(PERMISSION_CODES.IAM_ROLE_ASSIGNMENT_MANAGE_FINANCE_MANAGER) ||
      can(PERMISSION_CODES.IAM_ROLE_ASSIGNMENT_MANAGE_PLATFORM_ADMIN) ||
      can(PERMISSION_CODES.IAM_ROLE_ASSIGNMENT_MANAGE_SUPER_ADMIN) ||
